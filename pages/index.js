        ...
        <section className='min-h-screen'>
          <nav className='py-10 mb-6 flex justify-between items-center'>
            ...
            <ul className='flex items-center'>
              <li>
                <a className=' text-neutral-400 py-2 rounded-full mr-8 transition-all duration-1000 hover:shadow-lg hover:text-neutral-100' href="https://github.com/pedrolucaslcosta" target="_blank">
                  Github
                </a>
              </li>
              <li>
          ...
          <div className='grid grid-cols-3 gap-4'>
            ...
            '>
              ...
              <div className='text-base sm:text-xl flex justify-center sm:justify-start gap-3 sm:gap-4 text-black'>
                <a href='mailto:pedrolucaslcosta@gmail.com' target='_blank' className='text-sm font-semibold rounded-full bg-sky-800 text-sky-100 flex items-center px-5'>
                  Contact me
                </a>
                <a href='https://www.instagram.com/pedrolucaslco' target='_blank' className='bg-sky-800 p-3 rounded-full dark:bg-sky-800 dark:text-sky-100'>
                  <AiFillInstagram />
                </a>
                <a href='https://www.linkedin.com/in/pedrolucaslcosta' target='_blank' className='bg-sky-800 p-3 rounded-full dark:bg-sky-800 dark:text-sky-100'>
                  <AiFillLinkedin />
                </a>
                <a href='https://www.twitter.com/pedrolucaslco' target='_blank' className='bg-sky-800 p-3  rounded-full dark:bg-sky-800 dark:text-sky-100'>
                  <AiFillTwitterCircle />
                </a>
              </div>
            </div>
